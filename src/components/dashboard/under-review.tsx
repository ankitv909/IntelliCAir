...
const UnderReviewJob: React.FC<UnderReviewJobProps> = ({reviewJobs, onViewJobClick, pagination, onPageChange}) => {
    ...
    return (
        <div className={'py-0 flex flex-col w-full'}>
            <div className={'card-border-solid'}>
                ...
                {reviewJobs.length === 0 ? (
                    <p className='text-center'>No Under Review Jobs Available</p>
                ) : (
