...
const AccountVerificationModal=({open,setIsOpen, setSubmitModal}:any)=>{
    ...
    return(
        <Dialog sx={{padding: "0px 0px"}} open={open}>
            ...
            <DialogContent sx={{paddingX:'40px'}}>
                <Typography sx={{paddingY: "1rem"}} fontWeight={600} >Bank Account Verification Aggrement</Typography>
                <Box sx={{border: "4px solid rgba(0, 128, 89, 0.5)", borderRadius: "0.5rem", height: "200px", padding:  3,overflowY: "overlay"}}>
                    <ul>
                        <li><Typography fontWeight={500} fontSize={"0.8rem"} >BBB Company Existence & Rating Check Aggrement BBB</Typography></li>
                        <li><Typography fontWeight={500} fontSize={"0.8rem"} >BBB Company Existence & Rating Check Aggrement BBB </Typography></li>
                ...
                <Box sx={{paddingY: "1rem"}}>
                    <Box sx={{display: 'flex', justifyContent: 'start', alignItems: "center"}}>
                        ...
                        <Box >
                            <Typography fontWeight={500} fontSize={"0.8rem"} >I/ We agree for Account Verification</Typography>
                        </Box>
                    </Box>
