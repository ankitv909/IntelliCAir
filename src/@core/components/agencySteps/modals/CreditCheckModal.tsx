...
const CreditCheckModal=({openCredit,setIsOpenCredit, setSubmitCreditModal}:any)=>{
    ...
    return(
        <Dialog sx={{padding: "0px 0px"}} open={openCredit}>
            ...
            <DialogContent sx={{paddingX:'40px'}}>
                <Typography sx={{paddingY: "1rem"}} fontWeight={600} >Credit Check</Typography>
                ...
                <Box sx={{paddingY: "1rem"}}>
                    <Box sx={{display: 'flex', justifyContent: 'start', alignItems: "center"}}>
                        ...
                        <Box >
                            <Typography fontWeight={500} fontSize={"0.8rem"} >I/ We agree to Credit Check of our company</Typography>
                        </Box>
                    </Box>
