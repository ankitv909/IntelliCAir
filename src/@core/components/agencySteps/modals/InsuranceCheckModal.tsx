...
const InsuranceCheckModal=({openInsurence, setIsOpenInsurence, setInsuranceSubmitModal}:any)=>{
    const [checked, setChecked] = React.useState(false);

    const handleClose = () => {
        setIsOpenInsurence(false)
    }
    ...
    return(
        <Dialog sx={{padding: "0px 0px", }} open={openInsurence} PaperProps={{ sx: { borderRadius: "20px" } }}>
            ...
            <DialogContent sx={{paddingX:'40px'}}>
                <Typography sx={{paddingY: "1rem"}} fontWeight={600} >Insurance Validity Check</Typography>
                ...
                <Box sx={{paddingY: "1rem"}}>
                    <Box sx={{display: 'flex', justifyContent: 'start', alignItems: "center"}}>
                        ...
                        <Box >
                            <Typography fontWeight={500} fontSize={"0.8rem"} >I/ We Agree to Insurance Validity check of our company</Typography>
                        </Box>
                    </Box>
