...
const AchVerificationModal=({openAch,setOpenAch, setAchSubmitModal}:any)=>{
    ...
    return(
        <Dialog sx={{padding: "0px 0px"}} open={openAch}>
            <DialogTitle sx={{padding: 0}}>
                <Typography sx={{
                    ...
                    padding: 5,
                    fontWeight: "bold"
                }}>ACH Aggrement</Typography>
            </DialogTitle>
            <DialogContent sx={{paddingX:'40px'}}>
                <Typography sx={{paddingY: "1rem"}} fontWeight={600} >ACH Aggrement</Typography>
                ...
                <Box sx={{paddingY: "1rem"}}>
                    <Box sx={{display: 'flex', justifyContent: 'start', alignItems: "center"}}>
                        ...
                        <Box>
                            <Typography fontWeight={500} fontSize={"0.8rem"} >I/ We agree for ACH Aggrement</Typography>
                        </Box>
                    </Box>
