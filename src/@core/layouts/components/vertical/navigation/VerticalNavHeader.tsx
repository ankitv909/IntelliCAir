...
const VerticalNavHeader = (props: Props) => {
  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft(), justifyContent:'center' }}>
      {userNavMenuBranding ? (
        userNavMenuBranding(props)
      ) : (
        <LinkStyled href='/'>
         {/* <Image alt={themeConfig.templateName} priority={false} src={'/images/favicon-cropped.png'} width={30} height={20} />*/}
          <HeaderTitle variant='h6' sx={{ ...menuCollapsedStyles, ...(navCollapsed && !navHover ? {} : { ml: 0 }) }}>
            <Image alt={themeConfig.templateName} priority={false} src={'/images/LogoLine.svg'} width={150} height={80} />
          </HeaderTitle>
        </LinkStyled>
      )}
